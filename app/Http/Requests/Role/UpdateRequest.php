...
class UpdateRequest extends FormRequest
{
    ...
    {
        return auth()->user()?->role?->rl_update ?? false;
    }
    ...
    public function rules(): array
    {
        return [
            ...
            // Attendance
            'attndnc' => ['nullable', 'boolean'],
            'attndnc_read' => ['nullable', 'boolean'],
            'attndnc_create' => ['nullable', 'boolean'],
            'attndnc_update' => ['nullable', 'boolean'],
            'attndnc_delete' => ['nullable', 'boolean'],
            'attndnc_schedules' => ['nullable', 'boolean'],
            // Banking
            'bnkng' => ['nullable', 'boolean'],
            'bnkng_read' => ['nullable', 'boolean'],
            'bnkng_create' => ['nullable', 'boolean'],
            'bnkng_update' => ['nullable', 'boolean'],
            'bnkng_delete' => ['nullable', 'boolean'],
            // Expenses
            'expnss' => ['nullable', 'boolean'],
            'expnss_read' => ['nullable', 'boolean'],
            'expnss_create' => ['nullable', 'boolean'],
            'expnss_update' => ['nullable', 'boolean'],
            'expnss_delete' => ['nullable', 'boolean'],
            // Status
