...
var KTMenuHandlersInitialized = !1, KTMenu = function (e, t) {
    ...
    if (null != e) {
        ...
        !0 === KTUtil.data(e).has("menu") ? n = KTUtil.data(e).get("menu") : r(), n.click = function (e, t) {
            ...
            return function (e) {
                var t = h(e), n = k(t);
                if (null !== t && "dropdown" === v(t) && (l(t), n.length > 0)) for (var i = 0, r = n.length; i < r; i++) null !== n[i] && "dropdown" === v(n[i]) && l(tems[i])
            }(e)
    ...
    if (null != e) {
        var i = {
            ...
            if (null !== r && KTUtil.css(n.element, "right", r), null !== l) {
                ...
                if (g && g.length > 0) for (var v = 0, h = g.length; v < h; v++) KTUtil.css(g[v], "padding-top", String(c) + "px")
            }
        }, l = function () {
...
var KTCustomWidgets = {
    init: function () {
        !function () {
            ...
            if (e) {
                var t = {self: null, rendered: !1}, n = function () {
                    var n = parseInt(KTUtil.css(e, "height")), i = KTUtil.getCssVariableValue("--bs-gray-500"),
                        r = KTUtil.getCssVariableValue("--bs-gray-200"), o = {
