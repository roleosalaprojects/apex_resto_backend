...
(function () {
    ...
    var getValue = function (dataData, sourceInput) {
    ...
    var getDimensions = function (dataData) {
      var dimensions = {};
    ...
    var unwrap = function (data, sourceInput) {
      ...
      var get = getValue(dataData, sourceInput);
      return __assign(__assign(__assign(__assign(__assign({}, get('source')), get('altsource')), get('poster')), get('embed')), getDimensions(dataData));
    };
