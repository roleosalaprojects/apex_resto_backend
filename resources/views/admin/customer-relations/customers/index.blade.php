    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal-title">Delete Customer</h5>
            ...
            <div class="modal-body">
                <h5 id="customer_name">Name Here</h5>
                <label class="form-label">Are you sure you want to delete this Customer?</label>
            </div>
        ...
        $option = {
            ...
            columnDefs: [
                ...
                },
                {
                    targets: 3,
                    render: function(data, type, full){
                        return (full.accumulated_points) ? full.accumulated_points : 0
                    }
                }
			],
        };
        let dataTable = table.DataTable($option);
        const documentTitle = 'Customers Listing';
