...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item text-muted">Create Transfer Order</li>
@endsection
@section('actions')
    <button type="button" class="btn btn-sm btn-success" id="btnSubmit">Create</button>
@endsection
@section('content')
    {!! Form::open(['route'=>"transfers.store", "id"=>"createTransfer"]) !!}
...
@section('add-scripts')
    ...
    <script>
        $(document).ready(function () {
            ...
            form = document.querySelector("#createTransfer");
