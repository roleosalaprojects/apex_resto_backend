...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item  text-muted">Create new Item</li>
@endsection
{{-- @section('actions')
    {!! Form::submit("Save", ["class"=>"btn btn-sm btn-success", "form"=>"createItem"]) !!}
@endsection --}}
@section('content')
    <form action="{{ route('items.store') }}" method="POST" id="createItem" enctype="multipart/form-data">
        @csrf
        @method('POST')
    ...
    <script>
        $(document).ready(function () {
                ...
                if (unitSelect.val()) {
                    $.ajax({
                        ...
                        success: function (response) {
                            addToUnitTable(response, unitSelect.val());
                        },
            ...
            function assignVariables() {
                form = document.querySelector("#createItem");
