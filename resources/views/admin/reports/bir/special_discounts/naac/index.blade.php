@extends('layout.app')
@section('header')
    - National Athletes and Coaches Book
@endsection
@section('title')
    National Athletes and Coaches Book
@endsection
@section('breadcrumb')
    ...
    <li class="breadcrumb-item text-muted">National Athletes and Coaches Book</li>
@endsection
@section('actions')
                        ...
                        render: function (data, type, full) {
                            return `
                                <div class="d-flex justify-content-end">
                                    <a href="/admin/reports/bir/special_discounts/naac/${full.id}" target="_blank" class="btn btn-icon btn-info btn-sm">
