...
@endsection
@section('title')
    Person with Disability Book
@endsection
@section('breadcrumb')
    <li class="breadcrumb-item"><a class="" href="{{ route('admin.home') }}">Home</a></li>
    <li class="breadcrumb-item text-muted">Person with Disability Book</li>
@endsection
@section('actions')
                        ...
                        render: function (data, type, full) {
                            return `
                                <div class="d-flex justify-content-end">
                                    <a href="/admin/reports/bir/special_discounts/pwd/${full.id}" target="_blank" class="btn btn-icon btn-info btn-sm">
