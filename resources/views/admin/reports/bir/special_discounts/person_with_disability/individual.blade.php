@extends('layout.app')
@section('header')
    - BIR Person with Disability Book
@endsection
@section('title')
    BIR Person with Disability Book
@endsection
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a class="" href="{{route('reports.bir.specialDiscounts.pwd.index')}}">Person with Disability Book</a></li>
                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        render: function (data, type, full) {
                            console.log(full);
                            return numberWithCommas((full.vat_special_discounts + full.pwd_discount + full.vat_exempt).toFixed(2));
                        }
                    }
                ],
                ajax: {
                    ...
                    url: '{{ route('reports.bir.specialDiscounts.pwd.individual.pos.table') }}'
                },
            }
