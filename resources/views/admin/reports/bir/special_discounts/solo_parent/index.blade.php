...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item text-muted">Solo Parent Book</li>
@endsection
@section('actions')
                        ...
                        render: function (data, type, full) {
                            return `
                                <div class="d-flex justify-content-end">
                                    <a href="/admin/reports/bir/special_discounts/solo_parent/${full.id}" target="_blank" class="btn btn-icon btn-info btn-sm">
