...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a class="" href="{{route('reports.bir.specialDiscounts.soloParent.index')}}">Solo Parent Book</a></li>
                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        render: function (data, type, full) {
                            return numberWithCommas((full.vat_special_discounts + full.vat_exempt + full.sp_discount).toFixed(2));
                        }
                    }
                ],
                ajax: {
                    ...
                    url: '{{ route('reports.bir.specialDiscounts.soloParent.individual.pos.table') }}'
                },
            }
