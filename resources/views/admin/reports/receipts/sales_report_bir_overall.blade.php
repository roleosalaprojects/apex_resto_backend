...
@section('title')
    Terminal #: All POS | Date: {{$dateSelected}}
@endsection
@section('style')
        ...
        <div class="col-12">
            ...
            <table class="table table-striped" id="table">
                ...
                @foreach ($query as $item)
                    <tr>
                        {{-- Date --}}
                        <td>{{$item->sale_month}}/{{$item->sale_day}}/{{$item->sale_year}}</td>
                        <td>{{ $item->terminal }}</td>
                        {{-- Beginning SI/OR No. --}}
                        <td>{{$item->min_son}}</td>
                        {{-- Ending SI/OR No. --}}
                        <td>{{$item->max_son}}</td>
                        {{-- Grand Accumulating Sales Ending Blance --}}
                        <td>
                        ...
                        {{-- NON VAT Amount --}}
                        {{-- <td>{{number_format($item->non_vat, 2)}}</td> --}}
                        {{-- VAT-Exempt Sales --}}
