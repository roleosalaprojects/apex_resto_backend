...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item text-muted">Sales by Employee</li>
@endsection
@section('actions')
...
@section('content')
    ...
    <div class="card card-bordered mb-7">
        <div class="card-body">
            <div id="employees_chart" style="height: 500px;"></div>
        </div>
    </div>
...
@section('scripts')
    <script>
        $(document).ready(function(){
            ...
            // Chart
            var element = document.getElementById('employees_chart');
                ...
                ajax: {
                    ...
                    dataSrc: function(response){
                        chart.updateOptions({
                            series:[
                                {
                                    ...
                                    type: 'bar',
                                    stacked: true,
                                    data: response.employees.map(function(val){
                            ...
                            xaxis: {
                                categories: response.employees.map(function(e){
                                    return e.employees
                                })
                            }
                        });
            ...
            const documentTitle = 'Sales By Employees Report';
