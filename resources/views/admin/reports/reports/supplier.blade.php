...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item text-muted">Sales by Supplier</li>
@endsection
@section('actions')
...
@section('content')
    ...
    <div class="card card-bordered mb-7">
        <div class="card-body">
            <div id="supplier_chart" style="height: 500px;"></div>
        </div>
    </div>
...
@section('scripts')
    <script>
        $(document).ready(function(){
            ...
            // Chart
            var element = document.getElementById('supplier_chart');
            ...
            var tableOptions = {
                ...
                ajax: {
                    ...
                    url: '{{ route('reports.suppliers.data') }}',
            ...
            const documentTitle = 'Sales By Suppliers Report';
