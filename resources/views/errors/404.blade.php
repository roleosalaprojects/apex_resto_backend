...
<!--begin::Head-->
<head><base href="../../"/>
    <title>Rolworks - Page Not Found!</title>
    <meta charset="utf-8" />
...
<div class="d-flex flex-column flex-root" id="kt_app_root">
    <!--begin::Page bg image-->
    <style>body { background-image: url('{{ asset('assets/media/auth/bg6.jpg') }}'); } [data-bs-theme="dark"] body { background-image: url('{{ asset('assets/media/auth/bg6-dark.jpg') }}'); }</style>
    <!--end::Page bg image-->
