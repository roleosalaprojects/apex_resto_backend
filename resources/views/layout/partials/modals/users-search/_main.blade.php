        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                ...
                <div
                    ...
                    <!--begin::Wrapper-->
                    <div class="py-5">
<!--layout-partial:partials/modals/admin-search/partials/_suggestions.html-->
<!--layout-partial:partials/modals/admin-search/partials/_results.html-->
<!--layout-partial:partials/modals/admin-search/partials/_empty.html-->
                    </div>
                    <!--end::Wrapper-->
                </div>
                <!--end::Search-->
